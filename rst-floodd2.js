...
const randomString = randstr(10);
  ...
  [eko(1, 2) + "x-badsource-mount-" + eko(1, 2) + "--" + eko(2, 4)]: "-undefined-" + eko(1, 2) + "-" + eko(1, 2)
  }, {
    ...
    [eko(1, 2) + "x-emty-log-" + eko(1, 2) + "--" + eko(2, 4)]: "=dynamic-" + eko(1, 2) + "-" + eko(1, 2)
          ...
          const crisx = {
            ...
            ...(Math.random() < 0.5 ? { "crisx-purpose": "prefetch" } : {}),
            ...
            ...(Math.random() < 0.3 ? shtty[Math.floor(Math.random() * shtty.length)] : {}),
            ...(Math.random() < 0.3 ? shtty[Math.floor(Math.random() * shtty.length)] : {}),
            ...(Math.random() < 0.5 ? { ["rada-sys-" + generateRandomString(1, 9)]: generateRandomString(1, 10) + "-" + generateRandomString(1, 12) + "=" + generateRandomString(1, 12) } : {}),
            ...(Math.random() < 0.5 ? { ["fm-lmao-oo-" + generateRandomString(1, 9)]: generateRandomString(1, 10) + "-" + generateRandomString(1, 12) + "=" + generateRandomString(1, 12) } : {}),
